...
def run_eval(args):
    ...
    for temperature in run_config.temperatures:
        ...
        for init_depth, expand_depth in test_depths:
            run_config.init_depth = init_depth
            run_config.expand_depth = expand_depth
            if rank == 0:
                print(f"init_depth: {init_depth}, expand_depth: {expand_depth}")
