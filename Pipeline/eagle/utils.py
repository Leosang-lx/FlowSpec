...
def tree_decoding(  # input draft token tree, output their verified logits
        model,
        tree_candidates,
        past_key_values,
        tree_position_ids,
    ...
    # [explain] retrieve_indices are padded to the max depth with -1
    # [explain] tree logits of (1(B),S,V), logits is of (N_paths,max_Depth_paths,V)
